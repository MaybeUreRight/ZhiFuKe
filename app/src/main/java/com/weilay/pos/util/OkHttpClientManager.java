...
//					File apk_file = apk_file = new File(destFileDir + "/"
//							+ getFileName(url));
//					if (file.exists()) {
...
//					sendSuccessResultCallback(apk_file.getAbsolutePath(),
//							callback);
//				} catch (IOException e) {
...
//	}
//
//	private InputStream downAsyn(final String url, final ResultCallback callback) {
//		final Request request = new Request.Builder().url(url).build();
//		final Call call = mOkHttpClient.newCall(request);
//
//		call.enqueue(new Callback() {
...
//					// int inSampleSize =
//					// ImageUtils.calculateInSampleSize(actualImageSize,
//					// imageViewSize);
//					try {
//						is.reset();
//					} catch (IOException e) {
