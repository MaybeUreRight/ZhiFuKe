...
public final class CameraManager {
	...
	public static void init(Context context) {
		L.i("cameraManager init");
		L.i("cameraManager is null?" + (cameraManager == null));
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			int width = (int) (screenResolution.x * 0.9);
			// if (width < MIN_FRAME_WIDTH) {
			// width = MIN_FRAME_WIDTH;
			// } else if (width > MAX_FRAME_WIDTH) {
			// width = MAX_FRAME_WIDTH;
			// }
			int height = (int) (screenResolution.y * 0.9);
			...
			framingRect = new Rect(leftOffset, topOffset, leftOffset + width, (int) (topOffset + height*0.7));
		}
		return framingRect;
	}
